...
VALUES ('Ivo','Iviæ','iivic','password', true);
INSERT INTO user(ime, prezime,username,password,enabled)
VALUES ('Marko','Markiæ','mmarkic','password', true);
INSERT INTO user(ime, prezime,username,password,enabled)
VALUES ('Pero','Periæ','pperic','password', true);
INSERT INTO user(ime, prezime,username,password,enabled)
VALUES ('Adminko','Adminiæ','admin','password', true);
...
INSERT INTO biljeznica(naziv, opis)
VALUES('Napredne teme raèunalnih mreža', 'Bilješke s predavanja napredne teme
raèunalnih mreža');
